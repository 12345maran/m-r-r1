...
//        params.setPort(502);
     ...
     * @throws ModbusInitException
     */
    public static boolean writeCoil(String host,int slaveId, int writeOffset, boolean writeValue)
            throws ModbusTransportException, ModbusInitException {
        // 获取master
        ModbusMaster tcpMaster = getMaster(host);
        // 创建请求
     ...
     * @throws ModbusInitException
     */
    public static boolean writeCoils(String host,int slaveId, int startOffset, boolean[] bdata)
            throws ModbusTransportException, ModbusInitException {
        // 获取master
        ModbusMaster tcpMaster = getMaster(host);
        // 创建请求
     ...
     * @throws ModbusInitException
     */
    public static boolean writeRegister(String host,int slaveId, int writeOffset, short writeValue)
            throws ModbusTransportException, ModbusInitException {
        // 获取master
        ModbusMaster tcpMaster = getMaster(host);
        // 创建请求对象
     ...
     * @throws ModbusInitException
     */
    public static boolean writeRegisters(String host,int slaveId, int startOffset, short[] sdata)
            throws ModbusTransportException, ModbusInitException {
        // 获取master
        ModbusMaster tcpMaster = getMaster(host);
        // 创建请求对象
     ...
     * @throws ModbusInitException
     */
    public static void writeHoldingRegister(String host,int slaveId, int offset, Number value, int dataType)
    ...
    public static void main(String[] args) {
        try {
            //@formatter:off
            // 测试01
			//boolean t01 = writeCoil(1, 0, false);
